    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                @include("templates.top-search-bar")
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            @foreach($notificaciones as $notification)
                                <a class="dropdown-item d-flex align-items-center" href="{{url('notificaciones', $notification->id)}}">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">{{$notification->data['mensaje']}}</span>
                                    </div>
                                </a>
                            @endforeach
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Sistema POS 2019</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
